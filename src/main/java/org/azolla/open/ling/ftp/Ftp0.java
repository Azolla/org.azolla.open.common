...
public final class Ftp0
{
	...
	/**
	 * @see org.azolla.open.ling.ftp.Ftp0#listNames(String)
	 */
	...
	/**
	 * @see org.azolla.open.ling.ftp.Ftp0#listFiles(String)
	 */
	...
	/**
	 * @see org.azolla.open.ling.ftp.Ftp0#listFiles(String,FTPFileFilter)
	 */
