/*
 * @(#)Encode0.java		Created at 2013-7-1
 * 
...
public enum Encode0
{
    ...
    private class ByteEncode extends Encode
    {
         ...
         * 
         * @param testurl	URL
         * @return int	One of the encodings from the Encoding enumeration (GB2312, HZ, BIG5,
         ...
         * @return int	One of the encodings from the Encoding enumeration (GB2312, HZ,
            ...
            for(i = 0; i < rawtextlen - 1; i++)
            {
                ...
                else
                {
                    ...
                    i + 3 < rawtextlen && (byte) 0x30 <= rawtext[i + 1] && rawtext[i + 1] <= (byte) 0x39 && (byte) 0x81 <= rawtext[i + 2] && rawtext[i + 2] <= (byte) 0xFE && (byte) 0x30 <= rawtext[i + 3] && rawtext[i + 3] <= (byte) 0x39)
                    {
                        gbchars++;
                        /*
                         * totalfreq += 500; row = rawtext[i] + 256 - 0x81; if (0x40 <= rawtext[i+1] && rawtext[i+1] <= 0x7E) { column = rawtext[i+1] - 0x40; }
                         * else { column = rawtext[i+1] + 256 - 0x40; } //System.out.println("extended row " + row + " column " + column + " rawtext[i] " +
        ...
        /*
         * Function: big5plus_probability Argument: pointer to unsigned char array Returns : number from 0 to 100 representing probability text in array uses
         * Big5+ encoding
         */
        ...
        int euc_tw_probability(byte[] rawtext)
        {
            ...
            for(i = 0; i < rawtextlen - 1; i++)
            {
                ...
                { // high bit set
                    dbchars++;
                    if(i + 3 < rawtextlen && (byte) 0x8E == rawtext[i] && (byte) 0xA1 <= rawtext[i + 1] && rawtext[i + 1] <= (byte) 0xB0 && (byte) 0xA1 <= rawtext[i + 2] && rawtext[i + 2] <= (byte) 0xFE && (byte) 0xA1 <= rawtext[i + 3] && rawtext[i + 3] <= (byte) 0xFE)
                    { // Planes 1 - 16
                        cnschars++;
        ...
        int utf16_probability(byte[] rawtext)
        {
             ...
             * < rawtextlen && (rawtext[i+1] & (byte)0xBF) == rawtext[i+1]) { goodbytes += 2; i++; } } else if ((rawtext[i] & (byte)0xEF) == rawtext[i]) { //
             * Three bytes if (i+2 < rawtextlen && (rawtext[i+1] & (byte)0xBF) == rawtext[i+1] && (rawtext[i+2] & (byte)0xBF) == rawtext[i+2]) { goodbytes += 3;
             * i+=2; } } }
             * 
             * score = (int)(100 * ((float)goodbytes/(float)rawtext.length)); // An all ASCII file is also a good UTF8 file, but I'd rather it // get identified
             * as ASCII. Can delete following 3 lines otherwise if (goodbytes == asciibytes) { score = 0; } // If not above 90, reduce to zero to prevent
             * coincidental matches if (score > 90) { return score; } else { return 0; }
             */
        }

        /*
         * Function: ascii_probability Argument: byte array Returns : number from 0 to 100 representing probability text in array uses all ASCII Description:
         * Sees if array has any characters not in ASCII range, if so, score is reduced
         */
        ...
        void initialize_frequencies()
        {
             ...
             * GBFreq[29][30] = 147; GBFreq[15][91] = 146; GBFreq[54][72] = 145; GBFreq[51][75] = 144; GBFreq[33][67] = 143; GBFreq[41][50] = 142;
             * GBFreq[27][34] = 141; GBFreq[46][17] = 140; GBFreq[31][74] = 139; GBFreq[42][67] = 138; GBFreq[54][87] = 137; GBFreq[27][14] = 136;
             * GBFreq[16][63] = 135; GBFreq[16][5] = 134; GBFreq[43][23] = 133; GBFreq[23][13] = 132; GBFreq[31][12] = 131; GBFreq[25][57] = 130; GBFreq[38][49]
             * = 129; GBFreq[42][69] = 128; GBFreq[23][80] = 127; GBFreq[29][0] = 126; GBFreq[28][2] = 125; GBFreq[28][17] = 124; GBFreq[17][27] = 123;
             * GBFreq[40][16] = 122; GBFreq[45][1] = 121; GBFreq[36][33] = 120; GBFreq[35][23] = 119; GBFreq[20][86] = 118; GBFreq[29][53] = 117; GBFreq[23][88]
             * = 116; GBFreq[51][87] = 115; GBFreq[54][27] = 114; GBFreq[44][36] = 113; GBFreq[21][45] = 112; GBFreq[53][52] = 111; GBFreq[31][53] = 110;
             * GBFreq[38][47] = 109; GBFreq[27][21] = 108; GBFreq[30][42] = 107; GBFreq[29][10] = 106; GBFreq[35][35] = 105; GBFreq[24][56] = 104;
             * GBFreq[41][29] = 103; GBFreq[18][68] = 102; GBFreq[29][24] = 101; GBFreq[25][84] = 100; GBFreq[35][47] = 99; GBFreq[29][56] = 98; GBFreq[30][44]
             * = 97; GBFreq[53][3] = 96; GBFreq[30][63] = 95; GBFreq[52][52] = 94; GBFreq[54][1] = 93; GBFreq[22][48] = 92; GBFreq[54][66] = 91; GBFreq[21][90]
             * = 90; GBFreq[52][47] = 89; GBFreq[39][25] = 88; GBFreq[39][39] = 87; GBFreq[44][37] = 86; GBFreq[44][76] = 85; GBFreq[46][75] = 84;
             * GBFreq[18][37] = 83; GBFreq[47][42] = 82; GBFreq[19][92] = 81; GBFreq[51][27] = 80; GBFreq[48][83] = 79; GBFreq[23][70] = 78; GBFreq[29][9] = 77;
             * GBFreq[33][79] = 76; GBFreq[52][90] = 75; GBFreq[53][6] = 74; GBFreq[24][36] = 73; GBFreq[25][25] = 72; GBFreq[44][26] = 71; GBFreq[25][36] = 70;
             * GBFreq[29][87] = 69; GBFreq[48][0] = 68; GBFreq[15][40] = 67; GBFreq[17][45] = 66; GBFreq[30][14] = 65; GBFreq[48][38] = 64; GBFreq[23][19] = 63;
             * GBFreq[40][42] = 62; GBFreq[31][63] = 61; GBFreq[16][23] = 60; GBFreq[26][21] = 59; GBFreq[32][76] = 58; GBFreq[23][58] = 57; GBFreq[41][37] =
             * 56; GBFreq[30][43] = 55; GBFreq[47][38] = 54; GBFreq[21][46] = 53; GBFreq[18][33] = 52; GBFreq[52][37] = 51; GBFreq[36][8] = 50; GBFreq[49][24] =
             * 49; GBFreq[15][66] = 48; GBFreq[35][77] = 47; GBFreq[27][58] = 46; GBFreq[35][51] = 45; GBFreq[24][69] = 44; GBFreq[20][54] = 43; GBFreq[24][41]
             * = 42; GBFreq[41][0] = 41; GBFreq[33][71] = 40; GBFreq[23][52] = 39; GBFreq[29][67] = 38; GBFreq[46][51] = 37; GBFreq[46][90] = 36; GBFreq[49][33]
             * = 35; GBFreq[33][28] = 34; GBFreq[37][86] = 33; GBFreq[39][22] = 32; GBFreq[37][37] = 31; GBFreq[29][62] = 30; GBFreq[29][50] = 29;
             * GBFreq[36][89] = 28; GBFreq[42][44] = 27; GBFreq[51][82] = 26; GBFreq[28][83] = 25; GBFreq[15][78] = 24; GBFreq[46][62] = 23; GBFreq[19][69] =
             * 22; GBFreq[51][23] = 21; GBFreq[37][69] = 20; GBFreq[25][5] = 19; GBFreq[51][85] = 18; GBFreq[48][77] = 17; GBFreq[32][46] = 16; GBFreq[53][60] =
             * 15; GBFreq[28][57] = 14; GBFreq[54][82] = 13; GBFreq[54][15] = 12; GBFreq[49][54] = 11; GBFreq[53][87] = 10; GBFreq[27][16] = 9; GBFreq[29][34] =
             * 8; GBFreq[20][44] = 7; GBFreq[42][73] = 6; GBFreq[47][71] = 5; GBFreq[29][37] = 4; GBFreq[25][50] = 3; GBFreq[18][84] = 2; GBFreq[50][45] = 1;
             * GBFreq[48][46] = 0;
             */
             ...
             * Big5Freq[12][115] = 158; Big5Freq[15][66] = 157; Big5Freq[11][104] = 156; Big5Freq[23][106] = 155; Big5Freq[34][157] = 154; Big5Freq[32][94] =
             * 153; Big5Freq[29][88] = 152; Big5Freq[10][46] = 151; Big5Freq[13][118] = 150; Big5Freq[20][37] = 149; Big5Freq[12][30] = 148; Big5Freq[21][4] =
             * 147; Big5Freq[16][33] = 146; Big5Freq[13][52] = 145; Big5Freq[4][7] = 144; Big5Freq[21][49] = 143; Big5Freq[3][27] = 142; Big5Freq[16][91] = 141;
             ...
             * Big5Freq[20][55] = 8; Big5Freq[19][84] = 7; Big5Freq[21][82] = 6; Big5Freq[24][3] = 5; Big5Freq[13][70] = 4; Big5Freq[6][21] = 3;
             * Big5Freq[21][86] = 2; Big5Freq[12][23] = 1; Big5Freq[3][85] = 0; EUC_TWFreq[45][90] = 600;
             */
             ...
             * EUC_TWFreq[43][51] = 190; EUC_TWFreq[64][93] = 189; EUC_TWFreq[92][7] = 188; EUC_TWFreq[83][89] = 187; EUC_TWFreq[69][9] = 186; EUC_TWFreq[45][4]
             * = 185; EUC_TWFreq[53][9] = 184; EUC_TWFreq[43][2] = 183; EUC_TWFreq[35][11] = 182; EUC_TWFreq[51][25] = 181; EUC_TWFreq[52][71] = 180;
             * EUC_TWFreq[81][67] = 179; EUC_TWFreq[37][33] = 178; EUC_TWFreq[38][57] = 177; EUC_TWFreq[39][77] = 176; EUC_TWFreq[40][26] = 175;
