/*
 * @(#)Integer0Test.java		Created at 2013-7-9
 * 
...
/**
 * The coder is very lazy, nothing to write for this Integer0Test class
 *
...
public class Integer0Test
{
	...
	public void test()
	{
		assertTrue(Integer0.isInt("" + Integer.MAX_VALUE));
		assertTrue(!Integer0.isInt("" + Long.MAX_VALUE));
	}
